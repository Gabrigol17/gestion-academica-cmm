...
@actividad_evaluativa_bp.route('/actividades-evaluativas/<string:act_eva_uuid>', methods=['PUT'])
def actualizar(act_eva_uuid):
    return actividad_evaluativa_controller.actualizar(act_eva_uuid, request.get_json())


@actividad_evaluativa_bp.route('/actividades-evaluativas/<string:act_eva_uuid>', methods=['DELETE'])
def eliminar(act_eva_uuid):
    return actividad_evaluativa_controller.eliminar(act_eva_uuid)
